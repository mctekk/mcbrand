...
import { gewaerActionsDataEs } from "@/model/api/image-data/data";

import Brands from "@/components/atoms/brands";

import { gewaerImagesBrand } from "@/model/api";

import {  GLMenuEs } from "@/components/atoms/gewaerLeadMenu";
...
const PAGE_SECTIONS_LAUNCH: Record<string, ReactNode> = {
  ...
  gewaer: [
    ...
    <ImageChanger
      ...
      desc={
        "Gewaer ofrece un conjunto de funcionalidades diseñadas para mejorar la eficiencia y optimizar las operaciones, incluyendo portales dedicados para vendedores que ofrecen experiencias personalizadas, gestión de pedidos, rastreo de pedidos, automatización de aprobaciones, seguimiento en tiempo real y más."
      }
      double={600}
      top="-mt-16 "
      margenImagen="ml-16"
